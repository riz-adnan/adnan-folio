      ...
      <div className='fixed z-50 flex justify-between text-white bg-red-400 sm1:hidden md:hidden'>
        ...
        <div className='fixed right-0 flex justify-between mt-12 mr-20 border-0 border-red-500 w-fit'>
          ...
          <div className='text-sm border-0 border-green-500 ml-28'>
            <div><Link href="https://drive.google.com/file/d/1wsoqvmhNkwZfAJGvp5iui5ZWHChsJ7-m/view?usp=sharing" target="_blank" alt="" className="hover:text-blue-400">Resume</Link></div>
