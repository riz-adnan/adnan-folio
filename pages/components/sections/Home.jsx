      ...
      <div className="pb-40 overflow-hidden bg-black sm1:pt-16 md:pt-0">
        ...
        <div className="relative border-0 border-red-500 sm1:hidden md:block h-[50rem]">
          <div className="w-4/5 pt-20 m-auto border-0 border-red-500 opacity-1" id="main">
            ...
            <div className="absolute z-10 font-extrabold tracking-tighter text-white lg:text-8xl xl:text-9xl font-change2 top-[20rem] md:text-7xl sm3:text-7xl">I'm a Software</div>
            <div className="z-30 font-extrabold tracking-tighter text-white lg:text-8xl xl:text-9xl font-change2 font-stencil2 top-[20rem] absolute md:text-7xl sm3:text-7xl">I'm a Software</div>
            <div className="absolute z-10 font-extrabold tracking-tighter text-white lg:text-8xl xl:text-9xl font-change2 xl:top-[28rem] md:top-[25rem] lg:top-[26rem] md:text-7xl sm3:text-7xl"><span className="text-blue-400/30 font-stencil23">Dev</span><span className="sm1:block md:inline">eloper / Engineer</span></div>
            <div className="absolute z-30 font-extrabold tracking-tighter text-white lg:text-8xl xl:text-9xl font-change2 font-stencil2 md:top-[25rem] xl:top-[27.95rem] lg:top-[26rem] md:text-7xl sm3:text-7xl"><span className="text-blue-400/30 font-stencil23">Dev</span><span className="sm1:block md:inline">eloper / Engineer</span></div>
          </div>
          ...
          <div className="absolute w-4/5 m-auto border-0 border-red-500 top-[2rem] lg:left-[9rem] xl:left-[10rem] md:left-[5rem] z-20">
            <Image src="/media/images/meformal6.png" alt="" width={700} height={100} className="m-auto transition duration-300 transform grayscale"></Image>
          </div>
          <div className="absolute z-40 md:w-1/3 lg:w-1/4 xl:w-1/5 text-sm text-white md:left-[5rem] md:top-[31.5rem] lg:top-[34.5rem] xl:top-[38rem] xl:left-[10rem] lg:left-[6.5rem] sm3:w-1/2 sm3:top-[20rem] sm3:left-[5rem]">I am a passionate<span className="font-bold text-blue-400"> Software Engineer</span> driven to solve complex problems and deliver innovative, real-world solutions.</div>
          <div className="absolute z-30 flex space-x-3 lg:top-[35rem] xl:top-[38rem] md:right-8 xl:right-[10rem] md:top-[31rem]">
            <a href="https://github.com/riz-adnan" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.linkedin.com/in/adnan-rizvi-271165227/" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.instagram.com/iamrizvi_adnan/" target="_blank" rel="noreferrer" >
        ...
        <div id="home" className="relative top-0 max-h-screen bg-cover border-0 border-red-500 sm1:block md:hidden">
          <div className="w-full pt-20 m-auto border-0 border-red-500 opacity-1" id="main">
            ...
            <div className="relative z-10 w-full m-auto -ml-4 border-0 border-red-500">
              <Image src="/media/images/meformal6.png" alt="" width={800} height={100} className="m-auto transition duration-300 transform grayscale"></Image>
            </div>
            <div className="absolute z-0 font-extrabold tracking-tighter text-center text-white font-change2 sm1:text-5xl left-3 sm1:top-[14rem] md:top-[17rem] sm2:top-[15rem] sm2:text-6xl sm2:left-0 sm3:left-8">I'm Software</div>
            <div className="absolute z-20 font-extrabold tracking-tighter text-center text-white font-change2 font-stencil2 sm1:text-5xl left-3 sm1:top-[14rem] sm2:top-[15rem] md:top-[17rem] sm2:text-6xl sm2:left-0 sm3:left-8">I'm Software</div>
          ...
          <div className="absolute z-40 w-11/12 text-sm text-white border-0 border-red-500 top-[28rem] sm3:left-[2rem] sm1:left-[1rem] sm1:hidden">Hello,I&apos;m <span className="font-bold text-blue-400">Adnan Rizvi</span>,a passionate <span className="font-bold text-blue-400">Software Engineer</span> driven to solve complex problems and deliver innovative, real-world solutions.</div>
