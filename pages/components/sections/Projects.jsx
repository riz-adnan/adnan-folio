...
const Projects = () => {
  ...
  return (
    <div className='text-white bg-[#000] border-0 border-red-400'>  
      ...
      <div className='relative flex items-center justify-center border-0 border-blue-400'>
  <div className='relative'>
    <Image 
      ...
      width={600} 
      height={1800} 
      className='relative z-30 transition duration-300 ease-in-out -translate-x-1/2 border-0 border-red-500 cursor-pointer left-1/2 lg:hover:opacity-0' 
    />
    <Image 
      ...
      width={600} 
      height={1800} 
      className='absolute top-0 z-20 -translate-x-1/2 border-0 border-red-500 sm1:hidden lg:block left-1/2' 
    />
  </div>
  <div className='whitespace-nowrap font-extrabold text-center sm1:text-[20rem] md:text-[30rem] lowercase text-white tracking-tighter border-0 border-red-500 w-fit h-fit p-0 leading-[24rem] ml-8'>
    01.
  </div>
  <Lottie 
